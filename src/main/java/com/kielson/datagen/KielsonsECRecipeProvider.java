...
public class KielsonsECRecipeProvider extends FabricRecipeProvider {

    public KielsonsECRecipeProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> completableFuture) {
